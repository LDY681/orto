...
(function() {
  function L(a) {
    function m(a) {
      let f=a.charCodeAt(0); if (f!==92) return f; const b=a.charAt(1); return (f=r[b])?f:"0"<=b&&b<="7"?parseInt(a.substring(1), 8):b==="u"||b==="x"?parseInt(a.substring(2), 16):a.charCodeAt(1);
    } function e(a) {
...
f.length; ++c)i=f[c], b.push(e(i[0])), i[1]>i[0]&&(i[1]+1>i[0]&&b.push("-"), b.push(e(i[1]))); b.push("]"); return b.join("");
      ...
      } for (c=1; c<d.length; ++c)-1===d[c]&&(d[c]=++t); for (i=c=0; c<b; ++c) {
...
{b: 8, t: 9, n: 10, v: 11, f: 12, r: 13}, n=[], p=0, d=a.length; p<d; ++p) {
    ...
    } var e=/(?:^|\s)nocode(?:\s|$)/; var h=[]; var y=0; var t=[]; var s=0; let l; a.currentStyle?l=a.currentStyle.whiteSpace:window.getComputedStyle&&(l=document.defaultView.getComputedStyle(a, q).getPropertyValue("white-space")); var p=l&&"pre"===l.substring(0, 3); m(a); return {a: h.join("").replace(/\n$/, ""), c: t};
  } function B(a, m, e, h) {
...
"string")c=!1; else {
          ...
          c=o[1]; let j=f.indexOf(c); let k=j+c.length; o[2]&&(k=f.length-o[2].length, j=k-c.length); b=b.substring(5); B(l+i, f.substring(0, j), e, p); B(l+i+j, c, C(b, c), p); B(l+i+k, f.substring(k), e, p);
        } else p.push(l+i, b);
      }a.e=p;
    } var h={}; let y; (function() {
      for (var e=a.concat(m),
        l=[], p={}, d=0, g=e.length; d<g; ++d) {
        let r=e[d]; let n=r[3]; if (n) for (let k=n.length; --k>=0;)h[n.charAt(k)]=r; r=r[1]; n=""+r; p.hasOwnProperty(n)||(l.push(r), p[n]=q);
      }l.push(/[\S\s]/); y=L(l);
    ...
    function e(a) {
      switch (a.nodeType) {
        case 1: if (k.test(a.className)) break; if ("BR"===a.nodeName) {
          h(a),
          a.parentNode&&a.parentNode.removeChild(a);
        } else for (a=a.firstChild; a; a=a.nextSibling)e(a); break; case 3: case 4: if (p) {
          let b=a.nodeValue; const d=b.match(t); if (d) {
            const c=b.substring(0, d.index); a.nodeValue=c; (b=b.substring(d.index+d[0].length))&&a.parentNode.insertBefore(s.createTextNode(b), a.nextSibling); h(a); c||a.parentNode.removeChild(a);
          }
        }
      }
    } function h(a) {
      function b(a, d) {
        const e=d?a.cloneNode(!1):a; var f=a.parentNode; if (f) {
          var f=b(f, 1); let g=a.nextSibling; f.appendChild(e); for (let h=g; h; h=g)g=h.nextSibling, f.appendChild(h);
        } return e;
      }
    ...
    for (let e=m.length; --e>=0;) {
      const h=m[e]; A.hasOwnProperty(h)?window.console&&console.warn("cannot override language handler %s", h):A[h]=a;
    }
  } function C(a, m) {
    ...
    var m=
a.g; try {
      var e=M(a.h); var h=e.a; a.a=h; a.c=e.c; a.d=0; C(m, h)(a); const k=/\bMSIE\b/.test(navigator.userAgent); var m=/\n/g; const t=a.a; const s=t.length; var e=0; const l=a.c; const p=l.length; var h=0; const d=a.e; let g=d.length; var a=0; d[g]=s; let r; let n; for (n=r=0; n<g;)d[n]!==d[n+2]?(d[r++]=d[n++], d[r++]=d[n++]):n+=2; g=r; for (n=r=0; n<g;) {
...
I, J, v], hashComments: !0, cStyleComments: !0, multiLineStrings: !0, regexLiterals: !0}); var A={}; k(O, ["default-code"]); k(x([], [["pln", /^[^<?]+/], ["dec", /^<!\w[^>]*(?:>|$)/], ["com", /^<\!--[\S\s]*?(?:--\>|$)/], ["lang-", /^<\?([\S\s]+?)(?:\?>|$)/], ["lang-", /^<%([\S\s]+?)(?:%>|$)/], ["pun", /^(?:<[%?]|[%?]>)/], ["lang-", /^<xmp\b[^>]*>([\S\s]+?)<\/xmp\b[^>]*>/i], ["lang-js", /^<script\b[^>]*>([\S\s]*?)(<\/script\b[^>]*>)/i], ["lang-css", /^<style\b[^>]*>([\S\s]*?)(<\/style\b[^>]*>)/i], ["lang-in.tag", /^(<\/?[a-z][^<>]*>)/i]]),
    ...
    const h=document.createElement("PRE"); h.innerHTML=a; e&&D(h, e); E({g: m, i: e, h: h}); return h.innerHTML;
...
!k) {
          ...
          250):a&&a();
    } for (var e=[document.getElementsByTagName("pre"), document.getElementsByTagName("code"), document.getElementsByTagName("xmp")], h=[], k=0; k<e.length; ++k) for (let t=0, s=e[k].length; t<s; ++t)h.push(e[k][t]); var e=q; var l=Date; l.now||(l={now: function() {
      return +new Date;
    }}); var p=0; let d; var g=/\blang(?:uage)?-([\w.]+)(?!\S)/; m();
