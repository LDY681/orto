...
const siteMetadata = {
  ...
  comments: {
    ...
    //! Temporarily disabled as giscus requires github acc and disqus has ads. Comments are submmited as text in ratings table but no thread shall be displayed
